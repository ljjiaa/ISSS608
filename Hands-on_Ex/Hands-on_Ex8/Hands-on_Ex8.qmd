...
+------------------------+--------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------+
|                        | [`tbl_graph()`](https://tidygraph.data-imaginist.com/reference/tbl_graph.html) | [`as_tbl_graph()`](https://tidygraph.data-imaginist.com/reference/tbl_graph.html)                                              |
+========================+================================================================================+================================================================================================================================+
...
+------------------------+--------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------+
| Supported Data/Objects | -   A node **`data.frame`**                                                    | -   a node data.frame and an edge data.frame,                                                                                  |
|                        |                                                                                | -   data.frame, list, matrix from base,                                                                                        |
|                        | -   An edge **`data.frame`**                                                   | -   igraph from igraph,                                                                                                        |
...
-   [**activate()**](https://tidygraph.data-imaginist.com/reference/activate.html) verb from **tidygraph** serves as a switch between tibbles for nodes and edges. All dplyr verbs applied to **tbl_graph** object are applied to the active tibble.

![](images/image1.jpg){width="15cm" height="auto"}
...
![](images/image2.jpg){width="15cm" height="auto"} ![](images/image3.jpg){width="15cm" height="auto"}
...
+=================================================================================+========================================================================+======================+
| [`facet_edges()`](https://ggraph.data-imaginist.com/reference/facet_edges.html) | -   Create small multiples based on edge attributes                    | [click here](#edges) |
|                                                                                 |                                                                        |                      |
|                                                                                 | -   all nodes are displayed in every panel                             |                      |
+---------------------------------------------------------------------------------+------------------------------------------------------------------------+----------------------+
| [`facet_nodes()`](https://ggraph.data-imaginist.com/reference/facet_nodes.html) | -   Create small multiples based on node attributes                    | [click here](#nodes) |
|                                                                                 |                                                                        |                      |
|                                                                                 | -   each panel represents a subset of nodes                            |                      |
|                                                                                 |                                                                        |                      |
|                                                                                 | -   edges are only drawn in a panel if both terminal nodes are present |                      |
+---------------------------------------------------------------------------------+------------------------------------------------------------------------+----------------------+
| [`facet_graph()`](https://ggraph.data-imaginist.com/reference/facet_graph.html) | -   Create a grid of small multiples by node and/or edge attributes    | \-                   |
|                                                                                 |                                                                        |                      |
|                                                                                 | -   faceting on two variables simultaneously.                          |                      |
+---------------------------------------------------------------------------------+------------------------------------------------------------------------+----------------------+

### Working with `facet_edges()`{#edges}
...
### Working with `facet_nodes()`{#nodes}
...
`visNetwork()` looks for a field called **"group"** in the nodes object and colour the nodes according to the values of the group field. [`visNodes()`](https://datastorm-open.github.io/visNetwork/nodes.html) is used to change the properties of the nodes. Refer to this [link](https://search.r-project.org/CRAN/refmans/visNetwork/html/visNodes.html) for the documentation.
...
In the code run below [`visEdges()`](https://datastorm-open.github.io/visNetwork/edges.html) is used to symbolise the edges.

-   The argument *arrows* is used to define where to place the arrow.
-   The *smooth* argument is used to plot the edges using a smooth curve.

Refer to this [link](https://search.r-project.org/CRAN/refmans/visNetwork/html/visEdges.html) for the documentation.
